...
python -u v_1/src/linear_probing/03b_extract_random_seal_activations.py \
    ...
    --pooling mean \
    --output-dir v_1/src/linear_probing/results/orcc__embed/activations/random_maximal_mean \
...
python -u v_1/src/linear_probing/03b_extract_random_seal_activations.py \
    ...
    --text-col text_maximal \
    --pooling last \
    --output-dir v_1/src/linear_probing/results/orcc__embed/activations/random_maximal_last \
