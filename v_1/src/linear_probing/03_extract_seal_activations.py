"""
Step 3 — Extract Qwen2.5-7B-Instruct Activations for SEAL Fragments.
Loads seal_corpus.parquet and extracts mean-pooled activations at every
transformer layer (including embedding layer 0). Saves one .npz per layer.
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='Step 3: Extract Qwen activations for SEAL fragments')
    parser.add_argument(
