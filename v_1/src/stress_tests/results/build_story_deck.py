...
"c_kingtoken": """<section class="slide slide-text">
  ...
  <div class="cfg tight">
    ...
    <div class="cfg-k">Cleaning</div><div class="cfg-v">the fragment column uses our <strong>maximal</strong> regime, an eleven-filter pipeline plus truncation to 30 words. It strips digits, logograms (all-capital tokens), determinatives, case endings and plural markers, normalises long vowels, and lowercases everything. The reason is measured, not stylistic: without it a bag of n-grams reaches 99&#37; accuracy by reading <em>document length and royal-name spellings</em>, because well-preserved eras leave long inscriptions and poorly-preserved ones leave scraps. Truncation removes the length crutch, the filters remove the name crutch. The name column deliberately keeps the names, since that is what it is measuring.</div>
